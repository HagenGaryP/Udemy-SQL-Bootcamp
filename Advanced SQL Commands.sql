...
**********************	Lecture 58:	Timestamps and Extract 		***********************
...
For a full list of all the functions, visit https://www.postgresql.org/docs/9.5/static/functions-math.html
...
/		division (int division truncates the result)	4 / 2		2
...
For a full list of all the functions, visit https://www.postgresql.org/docs/9.5/static/functions-string.html
